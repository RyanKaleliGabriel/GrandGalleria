        ...
        <div class="row">
            <div class="col">
                ...
                <div class="card" style="background-color:#000000">
                    <div class="card-body">
                        <h5 class="card-title" style="color:#F9C5D5">Update {{$customer->name}}</h5>

                        <!-- Multi Columns Form -->
                        <form class="row g-3" action="{{route('updatecustomer', $customer->id)}}" method="post" id="customerForm">
                            @csrf
                            @method('PUT')
                            @if(Auth::check())
                            <div class="col-md-12">
                        ...
                        <script>
                            ...
                            form.addEventListener('submit', function(event) {
                                ...
                                if (form.checkValidity()) {
                                    ...
                                    Swal.fire({
                                        title: 'Proceed to update this Customer?',
